...
Built for the Reboot The Earth 2025 Hackathon at Doha, Qatar in colaboration with the United Nations OSS department. Developed by the **Coders Without Borders** team.

## Features
- Real time alerts for weather, pests and crop risks
- Dashboard interface for NGOs and support organization
- Farmer-first design, goal to evolve into a mobile app for direct access
- AI integration for image analysis

## Open Source Commitment
This project is licensed under the permissive MIT license. Collaborations and improvements are welcomed and encouraged.